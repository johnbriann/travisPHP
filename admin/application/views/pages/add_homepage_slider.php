...
<?php } ?>
<form id="add_user_form" action="<?= base_url()?>home/add_homepage_slider_process" method="POST" enctype="multipart/form-Data">
		...
		<div class="form-row">
			...
			<div class="col-md-12">
				<div class="position-relative form-group">
					...
					<input required type="text" id="description" name="description" class="form-control" placeholder="Description" />
				</div>
			</div>
			<!--
			<div class="col-md-4">
