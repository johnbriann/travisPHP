...
<?php } ?>
<form id="add_user_form" action="<?= base_url()?>home/edit_category_process/<?= $content_data['id']?>" method="POST" enctype="multipart/form-Data">
...
<div class="main-card mb-3 card">
	<div class="card-body">
		...
		<div class="form-row">
			...
			<div class="col-md-6">
				<div class="position-relative form-group">
					<img id="box_image" src="<?= IMGURL?>uploads/category/small_<?= $content_data['image']?>" />
				</div>
			</div>
		</div>
