...
<?php } ?>
<form id="add_user_form" action="<?= base_url()?>home/edit_user_process/<?= $userdata['id']?>" method="POST" enctype="multipart/form-Data">
<div class="main-card mb-3 card">
	<div class="card-body">
		<h5 class="card-title">User Role</h5>
		<select required id="role" name="role" class="multiselect-dropdown form-control">
			<option <?= ($userdata['role'] == '')?'selected':'';?> value="">Select User Role</option>
			<!--<option <?= ($userdata['role'] == 'customer')?'selected':'';?> value="customer">Customer</option>-->
			<option <?= ($userdata['role'] == 'rider')?'selected':'';?> value="rider">Rider</option>
			<option <?= ($userdata['role'] == 'subadmin')?'selected':'';?> value="subadmin">SubAdmin</option>
			<option <?= ($userdata['role'] == 'waiter')?'selected':'';?> value="waiter">Waiter</option>
		</select>
	</div>
</div>
<div class="main-card mb-3 card">
		...
		<div class="form-row">
			<div class="col-md-4">
				<div class="position-relative form-group">
					...
					<input required name="username" id="username" placeholder="Username" type="text" class="form-control" autocomplete="false" value="<?= $userdata['username']?>" />
				</div>
			</div>
			<div class="col-md-4">
				<div class="position-relative form-group">
					<label for="email" class="">Email</label>
					<input required  name="email" id="email" data-inputmask="'alias': 'email'" im-insert="true" class="form-control input-mask-trigger" autocomplete="false" value="<?= $userdata['email']?>" />
				</div>
			</div>
			<div class="col-md-4">
				<div class="position-relative form-group">
					<label for="password" class="">Password</label>
					<input name="password" id="password" placeholder="**Only if need changed" type="password" class="form-control" autocomplete="false" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="form-row">
			<div class="col-md-4">
				<div class="position-relative form-group">
					...
					<input required name="first_name" id="first_name" placeholder="First Name" type="text" class="form-control" value="<?= $userdata['first_name']?>" />
				</div>
			</div>
			<div class="col-md-4">
				<div class="position-relative form-group">
					<label for="last_name" class="">Last Name</label>
					<input required name="last_name" id="last_name" placeholder="Last Name" type="text" class="form-control" value="<?= $userdata['last_name']?>" />
				</div>
			</div>
		<select required class="form-control" id="country_code" name="country_code" style="display:none;">
			...
			<div class="col-md-4">
				<div class="position-relative form-group">
					...
					<input required name="phone" id="phone" placeholder="(555)-888-1111" type="text" class="form-control" value="<?= $userdata['phone']?>" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="form-row">
			<div class="col-md-6">
				<div class="position-relative form-group">
					...
					<input  name="building_name" id="building_name" placeholder="Building Name / Building No." type="text" class="form-control" value="<?= $userdata['building_name']?>" />
				</div>
			</div>
			<div class="col-md-6">
				<div class="position-relative form-group">
					<label for="area" class="">Area</label>
					<input  name="area" id="area" placeholder="Area" type="text" class="form-control" value="<?= $userdata['area']?>" />
				</div>
			</div>
		</div>
		<div class="form-row">
			<div class="col-md-6">
				<div class="position-relative form-group">
					...
					<input  name="house_flat" id="house_flat" placeholder="House / Flat" type="text" class="form-control" value="<?= $userdata['house_flat']?>" />
				</div>
			</div>
			<div class="col-md-6">
				<div class="position-relative form-group">
					<label for="address" class="">Street Address</label>
					<input  name="address" id="address" placeholder="Street Address" type="text" class="form-control" value="<?= $userdata['address']?>" />
				</div>
			</div>
		</div>
		<div class="form-row">
			<div class="col-md-12">
				<div class="position-relative form-group">
					...
					<input  name="extra_direction" id="extra_direction" placeholder="Extra Direction" type="text" class="form-control" value="<?= $userdata['extra_direction']?>" />
				</div>
			</div>
		</div>
