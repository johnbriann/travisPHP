...
<div class="app-page-title">
	<div class="page-title-wrapper">
		...
		<div class="page-title-actions">
			<a class="btn btn-info btn-sm btn-shadow mr-3" href="<?= base_url()?>brands">Back</a>
        </div>
	</div>
</div>
...
<?php } ?>
<form id="add_user_form" action="<?= base_url()?>home/edit_brand_process/<?= $content_data['id']?>" method="POST" enctype="multipart/form-Data">
		...
		<div class="form-row">
			<div class="col-md-6">
				<div class="position-relative form-group">
					...
					<input  type="file" id="image" name="image" class="form-control" onchange="cover_image_change(this,'brand','box')" />
				</div>
			</div>
			<div class="col-md-6">
				<div class="position-relative form-group">
					<img id="box_image" src="<?= IMGURL?>uploads/brand/small_<?= $content_data['image']?>" />
				</div>
			</div>
		</div>
