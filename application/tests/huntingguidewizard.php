	...
	if($usersignupbuttonclick){
		...
		if($standardsubscriptionbuttonclick){
			...
			if($registerwithemailbuttonclick){
				...
				$dropdown_guidetype = $web_driver->findElement(WebDriverBy::cssSelector("#user_type"))->findElement(WebDriverBy::cssSelector("option[value='2']"))->click();
																		...
																		if($radio_tripmultiple){
																			...
																			if($button_addmultiple){
																				...
																				if($submit_form_btn){
																					...
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Helicopter']"))->click();
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Plane']"))->click();
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Truck']"))->click();
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Jeep']"))->click();
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='High Seat']"))->click();
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Archery']"))->click();
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Rifles']"))->click();
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Shotguns']"))->click();
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Pistol']"))->click();
																					$checkbox_game = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Muzzleloader']"))->click();
																					$submit_form_btn = $web_driver->findElement(WebDriverBy::cssSelector("#submit-form-btn"))->click();
																					if($submit_form_btn){
																						sleep(2);
																						$input_address = $web_driver->findElement(WebDriverBy::cssSelector("#address"))->sendKeys("Los Angeles, CA, USA");
																						...
																						if($submit_form_btn){
																							sleep(2);
																							$input_boatname = $web_driver->findElement(WebDriverBy::cssSelector("#name"))->sendKeys("Guide".$randomid." Land");
