	...
	if($usersignupbuttonclick){
		...
		if($standardsubscriptionbuttonclick){
			...
			if($registerwithemailbuttonclick){
				...
				$dropdown_guidetype = $web_driver->findElement(WebDriverBy::cssSelector("#user_type"))->findElement(WebDriverBy::cssSelector("option[value='1']"))->click();
									...
									if($rotaterightbutton){
										...
										if($rotateleftbutton){
											...
											if($submit_form_btn){
												...
												if($submit_form_btn){
													sleep(2);
													$input_triptitle = $web_driver->findElement(WebDriverBy::cssSelector("#title"))->sendKeys("Guide".$randomid." Fishing Trip");
																	...
																	if($submit_form_btn){
																		...
																		if($radio_tripmultiple){
																			...
																			if($button_addmultiple){
																				...
																				if($submit_form_btn){
																					sleep(2);
																					$dropdown_species = $web_driver->findElement(WebDriverBy::cssSelector(".chosen-choices"))->click();
																					...
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Lure Trolling']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Bottom Fishing']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Jigging']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Kite Fishing']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Live Bait']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Artificial Baits']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Fly Fishing']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Frozen Bait']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Wade Fishing']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Fish Cleaning']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Cocktail Service']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Alcohol Provided']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Alcohol allowed']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Bait and Tackle']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Water']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Ice']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Breakfast']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Lunch']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Professional Photo']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Professional Video']"))->click();
																					$checkbox_species = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Snacks']"))->click();
																					$submit_form_btn = $web_driver->findElement(WebDriverBy::cssSelector("#submit-form-btn"))->click();
																					if($submit_form_btn){
																						sleep(2);
																						$radio_boat = $web_driver->findElement(WebDriverBy::cssSelector("#boat_yes"))->click();
																						if($radio_boat){
																							$submit_form_btn = $web_driver->findElement(WebDriverBy::cssSelector("#submit-form-btn"))->click();
																							if($submit_form_btn){
																								sleep(2);
																								$input_boatname = $web_driver->findElement(WebDriverBy::cssSelector("#name"))->sendKeys("Guide".$randomid." Boat");
																								$input_boathlength = $web_driver->findElement(WebDriverBy::cssSelector("#hlength"))->sendKeys("212");
																								$submit_form_btn = $web_driver->findElement(WebDriverBy::cssSelector("#submit-form-btn"))->click();
																								if($submit_form_btn){
																									sleep(2);
																									$file_input = $web_driver->findElement(WebDriverBy::cssSelector("#my_file"));
																									...
																									// if($input_file){
																										...
																										if($submit_form_btn){
																											sleep(2);
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Fighting Chair']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Cruising Speed']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Tournament Boat/Crew Ready']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Insurance Option']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='GPS']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Radar']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Sonar/FishFinder']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Outriggers']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Trolling Motor']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Power Pole']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Top Drive']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Downriggers']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Infrared']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='AutoPilot']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Trim Tabs']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Tuna Door']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Tuna Door']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Live Well']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Cooler Space']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Fighting Belt']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Fresh Water Tank']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Step Ladder']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Fish Box']"))->click();
																											$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Rods, Reels, and Tackle']"))->click();
																											$submit_form_btn = $web_driver->findElement(WebDriverBy::cssSelector("#submit-form-btn"))->click();
																											if($submit_form_btn){
																												sleep(2);
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Air Conditioning']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Cabin']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Shade']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Sun Deck']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Kitchen']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Dining Room']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Refrigerator']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Internet Wifi']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='TV']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Stereo']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Satellite TV']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Heater']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Restroom']"))->click();
																												$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Aux Input for phone']"))->click();
																												$submit_form_btn = $web_driver->findElement(WebDriverBy::cssSelector("#submit-form-btn"))->click();
																												if($submit_form_btn){
																													sleep(2);
																													$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Life Jackets']"))->click();
																													$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Fire Extinguishers']"))->click();
																													$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='First-Aid Equipment']"))->click();
																													$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Life Boat']"))->click();
																													$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Flares']"))->click();
																													$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='EPRIRB']"))->click();
																													$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='VHF Radio']"))->click();
																													$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='Satellite']"))->click();
																													$checkbox_boat = $web_driver->findElement(WebDriverBy::xpath("//input[@value='GPS']"))->click();
																													$submit_form_btn = $web_driver->findElement(WebDriverBy::cssSelector("#submit-form-btn"))->click();
																													if($submit_form_btn){
																														sleep(2);
